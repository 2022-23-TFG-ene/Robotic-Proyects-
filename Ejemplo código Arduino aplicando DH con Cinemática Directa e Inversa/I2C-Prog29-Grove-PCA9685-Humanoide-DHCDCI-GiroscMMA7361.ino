...
double MMA7361y;
double MMA7361z;
double contadorMMA7361General = 0;
double contadorMMA7361Corregir = 100;
double MMA7361xCorregir = 0;
double MMA7361yCorregir = 0;
double distanciaPiesEquilibrio = 11;
double diferenciaPiesCorregirEquilibrio = 0;
double MMA7361xInicial = 0;
double MMA7361yInicial = 0;
double MMA7361xFinalCorregirSinMapear = 0;
double MMA7361yFinalCorregirSinMapear = 0;
double MMA7361xFinalCorregirMapeado = 0;
double MMA7361yFinalCorregirMapeado = 0;
double MMA7361xAnterior = 0;
