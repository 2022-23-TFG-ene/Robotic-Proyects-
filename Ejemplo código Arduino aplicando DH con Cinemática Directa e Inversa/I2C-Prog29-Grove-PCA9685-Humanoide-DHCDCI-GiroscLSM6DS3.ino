...
// Esta parte viene de aplicar una solución según em modelo de SCARA.
    ...
    Teta4pgrados = radianesAGrados(Teta4pradianes) - (LSM6DS3xFinalCorregirSinMapear/3); // +- // /2 - porque se va acercando a la solución de forma iterativa - Se corrige el ángulo según el giroscopio.
    ...
    if (brazoN == 1) {
      ...
      Teta5pgrados = Teta1pgrados + (LSM6DS3yFinalCorregirSinMapear/3); // /2 - Se corrige el ángulo según el giroscopio 
    } else if (brazoN == 2) {
      //Teta5pgrados = Teta1pgrados + (MPU9250yFinalCorregirSinMapear); // /2 - Se corrige el ángulo según el giroscopio      
      Teta5pgrados = Teta1pgrados - (LSM6DS3yFinalCorregirSinMapear/3); // /2 - Se corrige el ángulo según el giroscopio      
    }    
...
void corregircentroGravedad() {
  ...
  puntoFinalAbsoluto(Long5i, Long6i, (Long7i+(diferenciaPiesCorregirEquilibrio/3)), piernaN1); // /2 - Se modifica la mitad de la altura en cada pierna.??????
  puntoFinalAbsoluto(Long5i, Long6i, (Long7i-(diferenciaPiesCorregirEquilibrio/3)), piernaN2); 
  ejecutarParalelo();
  //delay(tiempoEntreMovimientos); 
